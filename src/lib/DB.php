...
class DB
{
     ...
     * @return void
     */
    public function prepare(string $sql, string $paramType, ...$paramValues)
    {
     ...
     * @return void $stmt
     */
    public function insert(string $table,  array $columns, ...$paramValues)
    {
     ...
     * @return void $stmt
     */
    public function delete(string $table, string $column, $condition)
    {
